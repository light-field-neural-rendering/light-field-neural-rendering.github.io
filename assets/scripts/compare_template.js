...
function getBody(){
  ...
  <nav class="navbar is-fixed-top is-light" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
      <p class="navbar-item">
        <a href="../index.html" style="color:#4a4a4a"><b>Light Field Neural Rendering</b></a>
      </p>
  ...
  <section>
    <div id="control_tip" class="notification is-info is-light"	>
      Hover over the top menu number 1 - <span id="dataset-count-method"></span> to switch between the methods
    </div>  
  </section>
